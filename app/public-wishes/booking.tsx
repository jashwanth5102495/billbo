...
import { ArrowLeft, MapPin, Star, Info, X, Users, Eye, TrendingUp, Video, Clock, Zap } from 'lucide-react-native';
import { locationService, Location } from '../../services/locationService';



export default function PublicWishesBookingScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Select Billboard Location</Text>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.sectionTitle}>Interactive Billboard Locations</Text>
        ...
        {isLoading ? (
          ...
          >
            ...
            <View style={styles.locationInfo}>
              ...
              <Text style={styles.interactiveFeatures}>{location.interactiveFeatures}</Text>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Interactive Billboard Details</Text>
                <TouchableOpacity
              ...
              {infoLocation && (
                <ScrollView showsVerticalScrollIndicator={false}>
                  <View style={styles.infoRow}>
                    <Users size={20} color="#E74C3C" style={styles.infoIcon} />
                    <View style={{ flex: 1 }}>
                  ...
                  <View style={styles.infoRow}>
                    <Clock size={20} color="#F59E0B" style={styles.infoIcon} />
                    <View style={{ flex: 1 }}>
                  ...
                  <View style={styles.infoRow}>
                    <Zap size={20} color="#E74C3C" style={styles.infoIcon} />
                    <View style={{ flex: 1 }}>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Select Interactive Package</Text>
                <TouchableOpacity
                  style={styles.closeButton}
                ...
                {selectedLocation?.packages.map((pkg) => (
                  ...
                  >
                    ...
                    <View style={styles.packageDetails}>
                      ...
                      <Text style={styles.packageDuration}>Active Duration: {pkg.duration}</Text>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (selectedPackage && selectedLocation) {
                      ...
                      router.push({
                        pathname: '/public-wishes/details',
                        params: {
                          ...
                          category: params.category || 'Public Video Wishes',
