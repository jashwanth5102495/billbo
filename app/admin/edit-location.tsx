...
import { locationService, Package, Location } from '../../services/locationService';
...
export default function EditLocationScreen() {
    ...
    try {
      ...
      if (locationData) {
        ...
        setFormData({
          ...
          rating: locationData.rating.toString(),
          reviews: locationData.reviews.toString(),
          image: locationData.image,
          dailyFootfall: locationData.dailyFootfall,
          peakHours: locationData.peakHours,
          demographics: locationData.demographics || '',
          visibility: locationData.visibility || '',
          interactiveFeatures: locationData.interactiveFeatures || '',
        });
        setPackages(locationData.packages);
      } else {
  ...
  const handleSavePackage = () => {
    ...
    const newPackage: Package = {
      id: editingPackageIndex !== null ? packages[editingPackageIndex].id : Math.max(...packages.map(p => p.id), 0) + 1,
